...
const Contact = ({id}) => {
  return (
    ...
    <h3 className="text-5xl font-bold justify-center text-center -mb-12 text-purple-600">
        Contact Us
      </h3>
    <div className="min-h-screen  flex items-center justify-center  " >
    
      <div className="bg-white shadow-lg rounded-lg flex flex-col md:flex-row w-full max-w-5xl">
        <div className="p-6 bg-purple-300 md:w-1/2 flex flex-col justify-between">
          <div>
